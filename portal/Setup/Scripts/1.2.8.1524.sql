...
IF NOT EXISTS (SELECT * FROM [INFORMATION_SCHEMA].[COLUMNS] WHERE [TABLE_CATALOG] = 'Rainbow' AND [TABLE_NAME] = 'Modules' AND [COLUMN_NAME] = 'LastModified') 
BEGIN
...
SET @DesktopSrc = 'DesktopModules/RainbowVersion.ascx'
SET @MobileSrc = ''
