...
--IF NOT EXISTS (SELECT * FROM [INFORMATION_SCHEMA].[COLUMNS] WHERE [TABLE_CATALOG] = 'Rainbow' AND [TABLE_SCHEMA] = 'staging' AND [TABLE_NAME]='Links' AND [COLUMN_NAME] = 'Target') 
--Begin
--	ALTER Table [staging].[links]
