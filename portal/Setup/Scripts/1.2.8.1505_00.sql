...
SET Searchable = 1, ClassName = 'Rainbow.DesktopModules.Discussion'
WHERE GeneralModDefid = '{2D86166C-4BDC-4A6F-A028-D17C2BB177C8}'
GO

UPDATE GeneralModuleDefinitions
SET Searchable = 1, ClassName = 'Rainbow.DesktopModules.Announcements'
WHERE GeneralModDefid = '{CE55A821-2449-4903-BA1A-EC16DB93F8DB}'
GO

UPDATE GeneralModuleDefinitions
SET Searchable = 1, ClassName = 'Rainbow.DesktopModules.Articles'
WHERE GeneralModDefid = '{87303CF7-76D0-49B1-A7E7-A5C8E26415BA}'
GO

UPDATE GeneralModuleDefinitions
SET Searchable = 1, ClassName = 'Rainbow.DesktopModules.Contacts'
WHERE GeneralModDefid = '{2502DB18-B580-4F90-8CB4-C15E6E5339EF}'
GO

UPDATE GeneralModuleDefinitions
SET Searchable = 1, ClassName = 'Rainbow.DesktopModules.Documents'
