...
SET @ClassName = 'Rainbow.DesktopModules.SignIn'
SET @Admin = 0
SET @Searchable = 0
-- update module
...
SET @MobileSrc = ''
SET @AssemblyName = 'Rainbow.DLL'
SET @ClassName = 'Rainbow.DesktopModules.SignInCool'
SET @Admin = 0
SET @Searchable = 0
-- update module
EXEC [rb_AddGeneralModuleDefinitions] @GeneralModDefID, @FriendlyName, @DesktopSrc, @MobileSrc, @AssemblyName, @ClassName, @Admin, @Searchable
...
SET @MobileSrc = ''
SET @AssemblyName = 'Rainbow.DLL'
SET @ClassName = 'Rainbow.DesktopModules.SignInLink'
SET @Admin = 0
SET @Searchable = 0
-- update module
EXEC [rb_AddGeneralModuleDefinitions] @GeneralModDefID, @FriendlyName, @DesktopSrc, @MobileSrc, @AssemblyName, @ClassName, @Admin, @Searchable
...
SET @MobileSrc = ''
SET @AssemblyName = 'Rainbow.DLL'
SET @ClassName = 'Rainbow.DesktopModules.Shortcut'
SET @Admin = 0
SET @Searchable = 0
-- update module
EXEC [rb_AddGeneralModuleDefinitions] @GeneralModDefID, @FriendlyName, @DesktopSrc, @MobileSrc, @AssemblyName, @ClassName, @Admin, @Searchable
...
SET @MobileSrc = ''
SET @AssemblyName = 'Rainbow.DLL'
SET @ClassName = 'Rainbow.DesktopModules.ShortcutAll'
SET @Admin = 0
SET @Searchable = 0
-- update module
EXEC [rb_AddGeneralModuleDefinitions] @GeneralModDefID, @FriendlyName, @DesktopSrc, @MobileSrc, @AssemblyName, @ClassName, @Admin, @Searchable
...
SET @MobileSrc = ''
SET @AssemblyName = 'Rainbow.DLL'
SET @ClassName = 'Rainbow.DesktopModules.Pictures'
SET @Admin = 0
SET @Searchable = 1
-- update module
EXEC [rb_AddGeneralModuleDefinitions] @GeneralModDefID, @FriendlyName, @DesktopSrc, @MobileSrc, @AssemblyName, @ClassName, @Admin, @Searchable
...
SET @MobileSrc = ''
SET @AssemblyName = 'Rainbow.DLL'
SET @ClassName = 'Rainbow.DesktopModules.Documents'
SET @Admin = 0
SET @Searchable = 1
...
SET @AssemblyName = 'Rainbow.DLL'
SET @ClassName = 'Rainbow.DesktopModules.HtmlModule'
SET @Admin = 0
SET @Searchable = 1
...
SET @MobileSrc = ''
SET @AssemblyName = 'Rainbow.DLL'
SET @ClassName = 'Rainbow.DesktopModules.PortalSearch'
SET @Admin = 0
SET @Searchable = 0
