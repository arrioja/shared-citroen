...
EXEC rb_PortalSettings_IU 	0	,	N'SITESETTINGS_ALT_THEME'	,	N'DefaultAlternate'
GO
EXEC rb_PortalSettings_IU 	0	,	N'SITESETTINGS_PAGE_LAYOUT'	,	N'Default'
GO
EXEC rb_PortalSettings_IU 	0	,	N'SITESETTINGS_REGISTER_TYPE'	,	N'RegisterFull.ascx'
GO
EXEC rb_PortalSettings_IU 	0	,	N'SITESETTINGS_THEME'	,	N'Default'
GO
EXEC rb_PortalSettings_IU 	0	,	N'SITESETTINGS_LANGLIST'	,	N'en;it;ar;bg;ca;cs;da;de;es;es-ES;es-MX;fr;hr;is;ko;nl;nl-BE;no;pl;pt;ru;sl;sr-SP-Cyrl;sr-SP-Latn;sv;tr;uk;zh-CN;zh-TW;'
GO
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id(N'[rb_PortalSettings_IU]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE [rb_PortalSettings_IU]
GO
...
GO
EXEC rb_Modules_IU 	2,	1,	'{0B113F51-FEA3-499A-98E7-7B83C192FDBB}', 1, N'ContentPane', N'Rainbow Portal 2005 released!', N'Admins', N'All Users', N'Admins', N'Admins', N'Admins', 0, 0, NULL, 0, 0, NULL, NULL, '', NULL, '', NULL, 0, 0, N'Admins;', N'Admins;'
GO
...
EXEC rb_Tabs_IU 	270	,	100	,	1270	,	0	,	N'ThemeCachemanager'	,	N''	,	N'Admins;'	,	0	,	NULL
GO
EXEC rb_Modules_IU 	270, 270, '{48358161-D002-4D70-896A-49CF62D5110B}', 1, N'ContentPane', N'ThemeCachemanager', N'Admins', N'Admins;', N'Admins;', N'Admins;', N'Admins;', 0, 0, NULL, 0, 0, NULL, NULL, '', NULL, '', NULL, 0, 0, N'Admins;', N'Admins;'
GO
...
VALUES (2, 'Welcome to Rainbow Portal 2005.<br>You can start immediately to add content to your site. Type on the login box on your left <pre>admin@rainbowportal.net</pre> as email and <pre>admin</pre> as password. Enjoy.', '', '')
GO
...
SET       DesktopSrc = 'DesktopModules/RoleAssignment/RoleAssignment.ascx',
		  ClassName = 'Rainbow.DesktopModules.RoleAssignment'
