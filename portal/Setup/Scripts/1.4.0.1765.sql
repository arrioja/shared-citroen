...
GO
UPDATE rb_GeneralModuleDefinitions SET AssemblyName = 'Rainbow.Modules.SimpleMenu.DLL' WHERE (GeneralModDefID = '{D3182CD6-DAFF-4E72-AD9E-0B28CB44F006}')
UPDATE rb_GeneralModuleDefinitions SET ClassName = 'Rainbow.Modules.SimpleMenu.SimpleMenu' WHERE (GeneralModDefID = '{D3182CD6-DAFF-4E72-AD9E-0B28CB44F006}')
GO
