...
- Tested with Rainbow version 1.5.0.1789h - 22/01/2005
...
will show up in the dropdown list. Add <add key="QuoteFileFolder" value="~/Portals/_Rainbow/YourFolder/" />
in section <appSettings file="Rainbow.config">. 
