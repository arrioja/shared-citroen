...
namespace Rainbow.DesktopModules
{
	...
	public class BlogDB 
	{
		...
		/// <returns></returns>
		public int AddBlog(int moduleID, string userName, string title,  string excerpt, string description, DateTime startDate, bool isInNewsletter) 
		{
		...
		/// <param name="startDate"></param>
		/// <param name="isInNewsletter"></param>
		public void UpdateBlog(int moduleID, int itemID, string userName, string title, string excerpt, string description, DateTime startDate, bool isInNewsletter) 
		{
			if (userName.Length < 1) 
			{
				userName = "unknown";
