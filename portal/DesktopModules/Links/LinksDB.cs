...
namespace Rainbow.DesktopModules 
{
    ...
    public class LinkDB 
    {
		...
		/// <returns></returns>
        public int AddLink(int moduleID, int itemID, string userName, string title, string url, string mobileUrl, int viewOrder, string description, string target) 
        {
		...
		/// <param name="description"></param>
		/// <param name="target"></param>
        public void UpdateLink(int moduleID, int itemID, string userName, string title, string url, string mobileUrl, int viewOrder, string description, string target) 
        {
