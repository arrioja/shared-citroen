...
namespace Rainbow.DesktopModules 
{
    ...
    public class TasksDB 
	{
        ...
        public int AddTask(int moduleID, int itemID, string userName, string title, DateTime startDate, string description, string status, string priority, string assignedto, DateTime dueDate, int percentComplete)
		{
        ...
        public void UpdateTask(int moduleID, int itemID, string userName, string title, DateTime startDate, string description, string status, string priority, string assignedto, DateTime dueDate, int percentComplete)
		{
            if (userName.Length < 1) {
                userName = "unknown";
            }
