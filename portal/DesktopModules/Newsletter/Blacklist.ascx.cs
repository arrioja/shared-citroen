...
namespace Rainbow.Admin
{
	...
	public class Blacklist : PortalModuleControl 
	{
		...
		public override Guid GuidID 
		{
			get
			{
				return new Guid("{2502DB18-B580-4F90-8CB4-C15E6E531017}");
			}
		}
		...
		public Blacklist() 
		{
			...
			this._baseSettings.Add("BLACKLIST_SHOWCOLUMNLASTSEND", showColumnLastSend);

			SettingItem showAllUsers = new SettingItem(new BooleanDataType());
			showAllUsers.Order = 8;
			showAllUsers.Value = "False";
			this._baseSettings.Add("BLACKLIST_SHOWALLUSERS", showAllUsers);
			...
			this._baseSettings.Add("BLACKLIST_SHOWSUBSCRIBERSONLY", showSubscribersOnly);
		}
		...
		override protected void OnInit(EventArgs e)
		{
			...
			this.AddUrl = "~/DesktopModules/Newsletter/BlacklistEdit.aspx";
			base.OnInit(e);
		}
