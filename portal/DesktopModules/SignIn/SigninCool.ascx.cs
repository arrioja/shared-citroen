...
namespace Rainbow.DesktopModules
{
	...
	/// </summary>
	public class SigninCool : PortalModuleControl
	{
		...
		protected System.Web.UI.WebControls.PlaceHolder CoolTextPlaceholder;
		...
		public SigninCool()
		{
			SettingItem CoolText = new SettingItem(new Rainbow.UI.DataTypes.StringDataType());
			CoolText.Order = 10;
			this._baseSettings.Add("CoolText", CoolText);
		...
		public override Guid GuidID 
		{
			get
			{
				return new Guid("{99F3511F-737C-4b57-87C0-9A010AF40A9C}");
			}
		}
		#endregion
