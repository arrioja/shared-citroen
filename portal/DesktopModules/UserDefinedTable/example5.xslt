...
<?xmlspysamplexml C:\Documents and Settings\rsiera\Bureaublad\rainbow css\test.xml?>
...
* How to implement multilingual XLS:
  Here is a site with several methods (not all of them appropriat in Rainbow environement):
