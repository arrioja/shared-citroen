...
//		public virtual int IComparable.CompareTo:CompareTo:(object value)
		public virtual int CompareTo(object value)
		{
			...
			if ( this.QuestionOrder == compareOrder ) { return 0; }
			if ( this.QuestionOrder < compareOrder ) { return -1;}
			if ( this.QuestionOrder > compareOrder ) { return 1; }
            return 0;
        }
...
//		public virtual int : IComparable.CompareTo CompareTo( object value)  // JLH!!
		public virtual int CompareTo(object value)
		{
			...
			if ( this.OptionOrder == compareOrder ) { return 0;}
			if ( this.OptionOrder < compareOrder ) { return -1;}
			if ( this.OptionOrder > compareOrder ) { return 1;}
            return 0;
