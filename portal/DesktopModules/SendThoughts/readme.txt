SendThoughts - Input from user to webmaster via form/email
Credits: Vlado
...
Ver. 1.1 - 27. april 2003 - Updated to follow "Rainbow best practices"
Ver. 1.2 - 24. may 2003 - FAQs are now 100% ready for localization. 
           Localized strings will later be entered by Esperantus tool


Issues and Known problems:
- Tested with Rainbow version 1.2.8.1626 - 24/04/2003
- Version 1.2 only in english (the code is ready for localization! - Tanks to Marc B!)
- Results in a non-working FAQs module if both are used on same tabpage


Module settings
---------------
You must enter enter the Recipient's email in the module setting before
any user can use the module. 
The text in field "Description" is used as header in the module.
