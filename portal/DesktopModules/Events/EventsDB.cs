...
namespace Rainbow.DesktopModules
{
    ...
    public class EventsDB 
    {
		...
		/// <returns></returns>
        public int AddEvent(int moduleID, int itemID, string userName, string title, DateTime expireDate, string description, string wherewhen, bool AllDay, string StartDate, string StartTime) 
        {
		...
		/// <param name="StartDate"></param>
		/// <param name="StartTime"></param>
        public void UpdateEvent(int moduleID, int itemID, string userName, string title, DateTime expireDate, string description, string wherewhen,bool AllDay, string StartDate, string StartTime) 
        {
