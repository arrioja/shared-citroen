...
namespace Rainbow.DesktopModules
{
	...
	{
		protected System.Web.UI.WebControls.DataList dlPictures;
		protected Esperantus.WebControls.Label lblError;
		protected Rainbow.UI.WebControls.Paging pgPictures;
		...
		{
			dlPictures.RepeatDirection = (Settings["RepeatDirectionSetting"] == null ? RepeatDirection.Horizontal : 
				(RepeatDirection)Int32.Parse(((SettingItem) _baseSettings["RepeatDirectionSetting"])));
		...
		private void Pictures_ItemDataBound(object sender, DataListItemEventArgs e)
		{
			...
			try 
			{
				pictureItem = (PictureItem) Page.LoadControl(Rainbow.Settings.Path.ApplicationRoot + "/Design/PictureLayouts/" + Settings["ThumbnailLayout"]);
			}
			catch
			{
			...
			wVersion.Value = this.Version.ToString();
		...
		private void BindData(int page)
		{
			...
			DataSet dsPictures = pictures.GetPicturesPaged(ModuleID, page, Int32.Parse(Settings["PicturesPerPage"].ToString()), Version);
		...
		/// Default constructor
		/// </summary>
		[History("Tim Capps","tim@cappsnet.com","2.4 beta","2004/02/18","fixed order on settings and added ShowBulkLoad")]
		public Pictures()
		{
			...
			thumbnailResizeOptions.Add(new Option((int)ResizeOption.FixedWidthHeight, Esperantus.Localize.GetString("PICTURES_FIXED_WIDTH_AND_HEIGHT", "Fixed width and height", this)));
			thumbnailResizeOptions.Add(new Option((int)ResizeOption.MaintainAspectWidth, Esperantus.Localize.GetString("PICTURES_MAINTAIN_ASPECT_FIXED_WIDTH", "Maintain aspect fixed width", this)));
			thumbnailResizeOptions.Add(new Option((int)ResizeOption.MaintainAspectHeight, Esperantus.Localize.GetString("PICTURES_MAINTAIN_ASPECT_FIXED_HEIGHT", "Maintain aspect fixed height", this)));
			...
			originalResizeOptions.Add(new Option((int)ResizeOption.NoResize, Esperantus.Localize.GetString("PICTURES_DONT_RESIZE", "Don't Resize", this)));
			originalResizeOptions.Add(new Option((int)ResizeOption.FixedWidthHeight, Esperantus.Localize.GetString("PICTURES_FIXED_WIDTH_AND_HEIGHT", "Fixed width and height", this)));
			originalResizeOptions.Add(new Option((int)ResizeOption.MaintainAspectWidth, Esperantus.Localize.GetString("PICTURES_MAINTAIN_ASPECT_FIXED_WIDTH", "Maintain aspect fixed width", this)));
			originalResizeOptions.Add(new Option((int)ResizeOption.MaintainAspectHeight, Esperantus.Localize.GetString("PICTURES_MAINTAIN_ASPECT_FIXED_HEIGHT", "Maintain aspect fixed height", this)));
			...
			repeatDirectionOptions.Add(new Option((int)RepeatDirection.Horizontal, Esperantus.Localize.GetString("PICTURES_HORIZONTAL", "Horizontal", this)));
			repeatDirectionOptions.Add(new Option((int)RepeatDirection.Vertical, Esperantus.Localize.GetString("PICTURES_VERTICAL", "Vertical", this)));
			...
			foreach(string layoutControl in System.IO.Directory.GetFiles(HttpContext.Current.Server.MapPath(Rainbow.Settings.Path.ApplicationRoot + "/Design/PictureLayouts"), "*.ascx"))
			{
