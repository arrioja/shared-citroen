...
- Tested with Rainbow version 1.2.8.1711c
...
-----------------------------------
XML Type : URL
XML URL  : http://localhost/Rainbow/CommunityRSS.aspx?LT=Item
XML File : <empty>
XSL Type : Predefined
...
-----------------------------------
XML Type : URL
XML URL  : http://localhost/Rainbow/CommunityRSS.aspx?LT=Tab
XML File : <empty>
XSL Type : Predefined
