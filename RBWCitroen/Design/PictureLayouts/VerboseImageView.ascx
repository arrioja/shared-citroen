...
<table width="100%" cellspacing="0" cellpadding="0" border="0" runat="server" ID="Table1">
	<tr>
		<td align="center" colspan="2">
			...
			<a href='<%# Rainbow.HttpUrlBuilder.BuildUrl("~/DesktopModules/Pictures/PictureView.aspx","ItemID=" + GetMetadata("PreviousItemID")+ "&mid=" + GetMetadata("ModuleID") + "&wversion=" + GetMetadata("WVersion"))%>' runat="server" ID="A1">
				<img runat='server' border='0' src='<%# Rainbow.HttpUrlBuilder.BuildUrl("~/Design/PictureLayouts/previous.gif")%>' ID="Img1">	
			</a>
			<%}%>
			<%if (GetMetadata("NextItemID") != null) {%>
			<a href='<%# Rainbow.HttpUrlBuilder.BuildUrl("~/DesktopModules/Pictures/PictureView.aspx","ItemID=" + GetMetadata("NextItemID")+ "&mid=" + GetMetadata("ModuleID") + "&wversion=" + GetMetadata("WVersion"))%>' runat="server" ID="A2">
				<img runat='server' border='0' src='<%# Rainbow.HttpUrlBuilder.BuildUrl("~/Design/PictureLayouts/next.gif")%>' ID="Img2">
			</a>
			<%}%>		
		</td>
	</tr>
